...
SCRIPT2RUN="Change_sshkey.sh"
THISSCRIPT=$(basename $0)
KEY="~/.ssh/id_ed25519_05062022"
...
ssh -o StrictHostKeyChecking=no -o ConnectTimeout=5 -o BatchMode=yes -i $KEY -p $USEPORT sasauto@$IP "bash -s" <${TOP}/${SCRIPT2RUN}
RET=$?
if [ "$RET" -eq 255 ];then
