...
folder = "/Compute/PDR-ICP3.1"
network_label = "vxw-dvs-31-virtualwire-5-sid-5005-ag1-pdr-app-internal1"

##### Network #####
staticipblock = "100.64.69.0/24"
staticipblock_offset = 9
gateway = "100.64.69.1"
netmask = "24"
...
instance_name = "ag1pdr1icp1"
# Instance name and domain drive the naming of the VMs
instance_name = "ag1pdr1icp1"
domain = "pdr1.ag1.sp.ibm.local"

# Cluster_name and Cluster_CA_domain are used in the configuration of ICP
cluster_name = "ag1pdr1icp1"
cluster_CA_domain = "ag1pdr1icp1.pdr1.ag1.sp.ibm.local"
...
dockerproxy = "Environment=\"HTTP_PROXY=http://http://ag1pdr1prx.pdr1.ag1.sp.ibm.local:8080/\" \"HTTPS_PROXY=http://ag1pdr1prx.pdr1.ag1.sp.ibm.loca:8080/\" \"NO_PROXY=localhost,127.0.0.1,100.64.69.8,ag1pdr1icp1.pdr1.ag1.sp.ibm.local:8500\""
...
image_location = "nfs:100.64.68.10:/storage/icp/3.1/ibm-cloud-private-x86_64-3.1.1.tar.gz"

##### NFS Server #####
registry_mount_src = "100.64.68.10:/storage/user1-icp-31/registry"
audit_mount_src = "100.64.68.10:/storage/user1-icp-31/audit"
