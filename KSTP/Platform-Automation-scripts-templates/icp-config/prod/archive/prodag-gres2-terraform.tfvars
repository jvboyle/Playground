...
instance_name = "ag1gr1icp3"
domain = "gr1.ag1.sp.ibm.local"

# Cluster_name and Cluster_CA_domain are used in the configuration of ICP
cluster_name = "ag1gr1icp3"
cluster_CA_domain = "ag1gr1icp3.gr1.ag1.sp.ibm.local"
...
dockerproxy = "Environment=\"HTTP_PROXY=http://http://ag1pdr1prx.pdr1.ag1.sp.ibm.local:8080/\" \"HTTPS_PROXY=http://ag1pdr1prx.pdr1.ag1.sp.ibm.loca:8080/\" \"NO_PROXY=localhost,127.0.0.1,158.87.50.71,ag1gr1icp3.gr1.ag1.sp.ibm.local:8500\""


### NOTE.. the ICP NFS Server is always provisioned FIRST
