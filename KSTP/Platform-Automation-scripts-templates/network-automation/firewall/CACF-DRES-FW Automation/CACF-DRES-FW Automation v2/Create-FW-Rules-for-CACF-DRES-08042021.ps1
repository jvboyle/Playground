...
Get-NsxFirewallSection $DRESSectionName | New-NsxFirewallRule -Name "CAFCF Proxy to CPREM JH - Netcool" -Action allow -Source $proxy1_vm,$proxy2_vm -Service $Netcool -AppliedTo $proxy1_vm,$proxy2_vm,$dres_esg1,$dres_vpn1 -Disabled -Position bottom -EnableLogging
