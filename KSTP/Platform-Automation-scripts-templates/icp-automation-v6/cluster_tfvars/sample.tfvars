...
## ICP
############
icpversion = "3.2.1" # Tested for 3.1.x & 3.2.0 
instance_name = "agnsrlnicp1test"
domain = "sr1.ag1.sp.ibm.local"
# Comment out below line to disable Vulnerability Advisor
disabled_management_services = ["istio", "storage-glusterfs", "storage-minio","nvidia-device-plugin","multicluster-hub","mcm-kui","key-management","search","vulnerability-advisor"]
