...
variable "cluster_name" {
  description = "Name of the ICP cluster, will be used as ICP Cluster name"
  default     = "mycluster"
}

variable "cluster_CA_domain" {
  description = "Name of the ICP cluster domain, will be used as ICP Cluster domain name"
...
variable "nfs" {
  ...
  default = {
    ...
    export_disk_size      = "200"   # Specify size for docker disk, default 100.
...
variable "master" {
  ...
  default = {
    ...
    disk_size             = ""      # Specify size or leave empty to use same size as template.
    docker_disk_size      = "300"   # Specify size for docker disk, default 100.
    thin_provisioned      = ""      # True or false. Whether to use thin provisioning on the disk. Leave blank to use same as template
    eagerly_scrub         = ""      # True or false. If set to true disk space is zeroed out on VM creation. Leave blank to use same as template
    keep_disk_on_remove   = "false" # Set to 'true' to not delete a disk on removal.
...
variable "proxy" {
  ...
  default = {
    ...
    disk_size           = ""      # Specify size or leave empty to use same size as template.
    docker_disk_size    = "150"   # Specify size for docker disk, default 100.
    thin_provisioned    = ""      # True or false. Whether to use thin provisioning on the disk. Leave blank to use same as template
    eagerly_scrub       = ""      # True or false. If set to true disk space is zeroed out on VM creation. Leave blank to use same as template
    keep_disk_on_remove = "false" # Set to 'true' to not delete a disk on removal.
...
variable "management" {
  ...
  default = {
    ...
    disk_size           = ""      # Specify size or leave empty to use same size as template.
    docker_disk_size    = "250"   # Specify size for docker disk, default 100.
    thin_provisioned    = ""      # True or false. Whether to use thin provisioning on the disk. Leave blank to use same as template
    eagerly_scrub       = ""      # True or false. If set to true disk space is zeroed out on VM creation. Leave blank to use same as template
    keep_disk_on_remove = "false" # Set to 'true' to not delete a disk on removal.
...
variable "httpproxy" {
  description = "http proxy used for package manager"
  default     = ""
}

variable "httpsproxy" {
  description = "https proxy used for package manager"
  default     = ""
}

variable "dockerproxy" {
  description = "http and https proxy used for docker"
  default     = ""
}

variable "tillerproxy" {
  description = "http and https proxy used for Tiller"
  default     = ""
}
...
variable "objectstoragelocation_image" {
  description = "ICP image package location which need to get from object storage"
  default     = ""
}
