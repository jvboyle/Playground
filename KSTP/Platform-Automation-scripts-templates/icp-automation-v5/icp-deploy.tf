locals {
    ...
    disabled_list = "${list("disabled","enabled","disabled","disabled","disabled","disabled","disabled","disabled","disabled","disabled","disabled","disabled","disabled","disabled","disabled","disabled","disabled","disabled","disabled","disabled")}"
...
module "icpprovision" {
    ...
    icp_configuration = {
      ...
      "cluster_CA_domain"		= "${var.cluster_CA_domain}"      #cluster_CA_domain={{ cluster_name }}.sres01.poc.ispw.ibm.local
      "calico_ip_autodetection_method"  = "first-found"
      "default_admin_password"          = "${var.icppassword}"
      "tiller_http_proxy"		= "${var.tillerproxy}"
      "tiller_https_proxy"              = "${var.tillerproxy}"
