locals {
  bgb_neighbor = [
    ...
    "100.64.65.21", # ag1-t0-dr-shared-001
    "100.64.65.22", # ag1-t0-dr-shared-001
    # "100.64.65.23", # ag1-t0-dr-0308
    # "100.64.65.24", # ag1-t0-dr-0308
...
resource "nsxt_policy_bgp_neighbor" "bpg_neighbor" {
  ...
  source_addresses = ["100.64.65.23", "100.64.65.24"]
