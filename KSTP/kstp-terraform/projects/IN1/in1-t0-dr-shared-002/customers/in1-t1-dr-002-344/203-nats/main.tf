...
locals {
  internal_vip    = "100.126.162.50/32"
  external_vip    = "158.87.104.50/32"
  external_proxy1 = "158.87.104.51/32"
  external_proxy2 = "158.87.104.52/32"
  internal_proxy1 = "100.126.162.51/32"
  internal_proxy2 = "100.126.162.52/32"
}
...
resource "nsxt_policy_nat_rule" "snat01" {
  ...
  action              = "SNAT"
  destination_networks = ["172.18.134.225/32","172.18.134.225/32"]
