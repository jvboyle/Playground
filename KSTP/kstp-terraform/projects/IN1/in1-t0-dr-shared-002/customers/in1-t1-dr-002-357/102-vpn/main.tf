...
resource "nsxt_policy_ipsec_vpn_local_endpoint" "local_ep" {
  ...
  local_address = "169.38.109.203"                       # update with Endpoint ip,
}
# 
module "vpn-1" {
  ...
  endpoint_local_address      = "169.38.109.203"
  ...
  ike_digest_algorithms       = "SHA2_512"                                         # SHA2_256 SHA2_512 SHA2_384 SHA1
  ike_dh_groups               = "GROUP21"                                          # GROUP2 GROUP5 GROUP20 GROUP16 GROUP15 GROUP14 GROUP21 GROUP19
  ...
  ipsec_digest_algorithms     = "SHA2_512" # SHA2_256 SHA2_512 SHA2_384 SHA1
  ipsec_dh_groups             = "GROUP21"  # GROUP2 GROUP5 GROUP20 GROUP16 GROUP15 GROUP14 GROUP21 GROUP19
  ipsec_sa_life_time          = "3600"
  vpn_service_path            = nsxt_policy_ipsec_vpn_service.vpn.path
  peer_address                = "169.38.91.4" # Remote peer ip 
  next_hop                    = "169.38.91.4" # NSX ip 

  bypass_rule_config = {
    sources      = ["158.87.104.0/24"]
    destinations = ["10.162.35.133/32", ]
  }
}
