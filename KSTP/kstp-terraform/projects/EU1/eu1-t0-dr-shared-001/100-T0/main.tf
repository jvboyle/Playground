data "nsxt_policy_edge_cluster" "ec" {
  display_name = "eu1-dres-etn-cluster-001"
}
...
resource "nsxt_policy_tier0_gateway" "tier0_gw" {
  ...
  transit_subnets      = ["100.72.48.32/27"]
  edge_cluster_path    = data.nsxt_policy_edge_cluster.ec.path
