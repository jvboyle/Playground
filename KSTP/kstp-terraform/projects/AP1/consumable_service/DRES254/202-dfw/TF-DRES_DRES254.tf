resource "nsxt_policy_security_policy" "policies_TF-DRES_254-DRES_254" {
   ...
   rule {
         ...
         destination_groups = [
               "/infra/domains/default/groups/TF-AP1-IPSET-Host-ap1sr1lcacfjump01",
               "/infra/domains/default/groups/TF-AP1-IPSET-Host-ap1sr1lcacfjump02"
            ]
         action = "ALLOW"
         services = [
      ...
      rule {
         display_name = "TF-cacfjump-to-proxy"
         notes        = ""
         source_groups = [
               "/infra/domains/default/groups/TF-AP1-IPSET-Host-ap1sr1lcacfjump01",
               "/infra/domains/default/groups/TF-AP1-IPSET-Host-ap1sr1lcacfjump02"
