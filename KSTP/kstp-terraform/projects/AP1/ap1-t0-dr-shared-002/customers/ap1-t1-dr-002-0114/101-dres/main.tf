...
module "dres" {
  ...
  nsx_id              = var.customer
  segment_name        = "/infra/segments/ap1-dr-0114-app-01"
...
/* : NOt Required because we are using and already Existend segment briged with NSX V
